...
drawText(String text) {
  ...
  var scale = _size / face["resolution"];
  // RenderText
...
generateShapes(text, [int size = 100, int curveSegments = 4, String font = "helvetiker", String weight = "normal", String style = "normal"]) {
