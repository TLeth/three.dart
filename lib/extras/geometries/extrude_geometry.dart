...
class ExtrudeGeometry extends Geometry {
  ...
  ExtrudeGeometry(this.shapes, {amount: 100, bevelThickness: 6.0, bevelSize: null, bevelSegments: 3, bevelEnabled: true, curveSegments: 12, steps: 1, //can assume a number of steps or a List with all U's of steps
  bendPath, extrudePath, frames, material, extrudeMaterial}) : super() {
    ...
    addShapeList(shapes, amount, bevelThickness, bevelSize, bevelSegments, bevelEnabled, curveSegments, steps, bendPath, extrudePath, frames, material, extrudeMaterial);
  ...
  addShapeList(shapes, amount, bevelThickness, bevelSize, bevelSegments, bevelEnabled, curveSegments, steps, bendPath, extrudePath, frames, material, extrudeMaterial) {
    ...
    for (var s = 0; s < sl; s++) {
      var shape = shapes[s];
      addShape(shape, amount, bevelThickness, bevelSize, bevelSegments, bevelEnabled, curveSegments, steps, bendPath, extrudePath, frames, material, extrudeMaterial);
    }
  }
  ...
  _getBevelVec2(Vector2 pt_i, Vector2 pt_j, Vector2 pt_k) {
    ...
    var intersection;
    var s;
    var q_sub_p_dot_w_hat;
    var v_dot_w_hat;
    var w;
    var v;
    var q = ExtrudeGeometry.__v6;
    var p = ExtrudeGeometry.__v5;
    var w_hat = ExtrudeGeometry.__v4;
    var v_hat = ExtrudeGeometry.__v3;
    var b = ExtrudeGeometry.__v2;
...
// Algorithm 2
  ...
  addShape(Shape shape, amount, bevelThickness, bevelSize, bevelSegments, bevelEnabled, curveSegments, steps, bendPath, extrudePath, TubeGeometry frames, material, extrudeMaterial, {ExtrudeGeometryWorldUVGenerator UVGenerator}) {
    ...
    List holesMovements = [];
    List verticesMovements = new List.from(contourMovements);
    List oneHoleMovements;
    ...
    f3(a, b, c, isBottom) {
      ...
      var uvs = isBottom ? uvgen.generateBottomUV(this, shape, null, a, b, c) : uvgen.generateTopUV(this, shape, null, a, b, c);
...
class ExtrudeGeometryWorldUVGenerator {
  ...
  generateSideWallUV(geometry, extrudedShape, wallContour, extrudeOptions, indexA, indexB, indexC, indexD, stepIndex, stepsLength) {
    var ax = geometry.vertices[indexA].x;
