...
class SphereGeometry extends Geometry {
  ...
  SphereGeometry([this.radius = 50.0, int segmentsWidth = 8, int segmentsHeight = 6, double phiStart = 0.0, double phiLength = Math.PI * 2.0, double thetaStart = 0.0, double thetaLength = Math.PI]) : super() {
