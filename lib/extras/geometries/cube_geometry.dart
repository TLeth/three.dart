...
class CubeGeometry extends Geometry {
  ...
  CubeGeometry(double width, double height, double depth, [this.segmentsWidth = 1, this.segmentsHeight = 1, this.segmentsDepth = 1, materialOrList, List sides])
      : super() {
...
//        vector[ w ] = depth;
    ...
    for (int iy = 0; iy < gridY; iy++) {
      for (int ix = 0; ix < gridX; ix++) {
        ...
        newUVs.addAll([new UV(ix / gridX, 1 - iy / gridY), new UV(ix / gridX, 1 - (iy + 1) / gridY), new UV((ix + 1) / gridX, 1 - (iy + 1) / gridY), new UV((ix + 1) / gridX, 1 - iy / gridY)]);
