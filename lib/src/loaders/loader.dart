...
class Loader {
  ...
  _hasNormals(Geometry geometry) {
    ...
    var m;
    var il = geometry.materials.length;
    var i;
  ...
  _createMaterial(Map m, String texturePath) {
    ...
    if (m.containsKey("mapNormal")) {
      ...
      material = new ShaderMaterial(fragmentShader: shader.fragmentShader, vertexShader: shader.vertexShader, uniforms: uniforms//lights: true,
      //fog: true
      );
      ...
      switch (mtype) {
        case "MeshLambertMaterial":
          material = new MeshLambertMaterial(map: map, color: color, ambient: ambient, lightMap: lightMap, specularMap: specularMap, vertexColors: vertexColors, wireframe: wireframe, side: FrontSide, opacity: opacity, transparent: transparent, blending: blending, depthTest: depthTest, depthWrite: depthWrite, visible: visible);
          break;

        case "MeshPhongMaterial":
          material = new MeshPhongMaterial(map: map, color: color, ambient: ambient, shininess: shininess, lightMap: lightMap, bumpMap: bumpMap, bumpScale: bumpScale, specularMap: specularMap, vertexColors: vertexColors, wireframe: wireframe, side: FrontSide, opacity: opacity, transparent: transparent, blending: blending, depthTest: depthTest, depthWrite: depthWrite, visible: visible);
          break;

        case "MeshBasicMaterial":
          material = new MeshBasicMaterial(map: map, color: color, lightMap: lightMap, specularMap: specularMap, vertexColors: vertexColors, wireframe: wireframe, side: FrontSide, opacity: opacity, transparent: transparent, blending: blending, depthTest: depthTest, depthWrite: depthWrite, visible: visible);
          break;
