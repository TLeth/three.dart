...
class MeshLambertMaterial extends Material implements Lighting, TextureMapping, EnvironmentMapping, Skinning, Morphing, Wireframe {
  Map _parameters;
